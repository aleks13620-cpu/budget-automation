...
> ★ **Текущий стратегический план — [PLAN_track_A_B_metric_gated_2026-06-11](active/PLAN_track_A_B_metric_gated_2026-06-11.md)** (действующий, авторитетный).
> Раздел «Текущая фаза» ниже — **история фазы стабилизации прода (май 2026)**, оставлен для контекста; это НЕ текущий статус.
