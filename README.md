...
- **Парсинг:** xlsx (Excel); pdfplumber (Python, первичный путь для PDF-спецификаций, с 2026-05-14) + pdf-parse (TS, PDF-счета)
- **Сопоставление:** string-similarity (Dice coefficient) + Gemini-tier (LLM-предложения поверх правил/Dice, фаза 8.1)
...
Система использует 5 уровней сопоставления (по убыванию приоритета):
...
5. **Gemini-tier (LLM-предложения)** — для строк, не закрытых уровнями 0–3 (`matchType: 'llm_suggestion'`, фаза 8.1 от 2026-05-10)
